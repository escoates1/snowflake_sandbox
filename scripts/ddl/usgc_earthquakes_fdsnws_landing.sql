CREATE TABLE IF NOT EXISTS DWH_DEV.RAW.USGS_EARTHQUAKES_FDSNWS_LANDING (
    -- Event identifier
...
COMMENT = 'Landing table for USGS Earthquake FDSNWS GeoJSON API data (magnitude >= 5) that stores only the records from the latest batch.';

CREATE TABLE IF NOT EXISTS DWH_TEST.RAW.USGS_EARTHQUAKES_FDSNWS_LANDING (
    -- Event identifier
    ID                      VARCHAR(50)     COMMENT 'Unique event identifier',
...
CREATE TABLE IF NOT EXISTS DWH_PROD.RAW.USGS_EARTHQUAKES_FDSNWS_LANDING (
    -- Event identifier
    ID                      VARCHAR(50)     COMMENT 'Unique event identifier',
